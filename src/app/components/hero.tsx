...
const Hero = () => {
  return (
    <div className="h-[704px] bg-[url('/assets/herob.jpg')] bg-cover bg-center flex items-center justify-end">
        <div className='h-[444px] w-[90%] md:w-[630px] bg-white m-[20px] md:m-[120px]'>
        <div className='m-5 p-4 w:[90%] md:w-[100%]  h-[286px] flex flex-col items-start justify-between'>
