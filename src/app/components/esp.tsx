...
const Esp = () => {
  return (
    <div className="h-auto md:h-[444px] bg-[url('/assets/email2.jpg')] bg-cover bg-center flex flex-col justify-center items-center p-5 text-[white] ">
     <h1 className='text-[20px] md:text-[32px] '>Join the club and get the benefits</h1> 
     ...
     <p className='text-[14px] md:text-[18px]'>Sign up for our newsletter and receive exclusive offers on new ranges, sales, pop up stores and more</p>
      ...
      <div className="w-90% md:w-[472px] h-auto md:h-[56px] flex items-center justify-center mt-8">
        ...
        <input
          ...
          />
          <button className="w-[25%] px-3 py-2 bg-primaryblue text-white font-medium text-[12px] ">
          Sign up
          </button>
  </div>
</div>
