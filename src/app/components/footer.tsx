...
const Footer = () => {
    return (
        <div className="h:[200px] md:h-[380px] w-[100%] flex flex-wrap justify-center  bg-primaryblue">
            
          <div className="bg-primaryblue w-[90%] flex justify-between  h-[280px] text-[#d7d6dd] border-b border-[#4e4d93] ">
            ...
            <div className=" md:w-[33%] h-[56px] flex items-center justify-center mt-8">
                <div className="  md:w-full max-w-md mt-16 text-[18px] font-medium">
                    ...
                    />
                    <button className="px-6 py-2 bg-white text-primaryblue font-medium ">
                    Sign up
                    </button>
                </div>
            </div>
        ...
        <div className='w-[90%] flex flex-row justify-between items-center'>
            ...
            <div className='w-[263px] flex justify-between '>
